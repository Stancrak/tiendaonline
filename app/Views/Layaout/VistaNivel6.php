            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="?route=usuario">Agregar Visitas</a>
                        <a class="collapse-item" href="?route=espera">Usuarios en espera</a>
                        <a class="collapse-item" href="?route=tiempoEspera">Tiempo</a>
                        <a class="collapse-item" href="?route=listaUs">Lista Usuarios</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="?route=diario">Reportes Diarios</a>
                        <a class="collapse-item" href="?route=general">Reporte General</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                ...
                                <span class="dropdown-item"><i class="fas fa-level-up-alt mr-2"></i> Nivel: <?php echo htmlspecialchars("6"); ?></span>
